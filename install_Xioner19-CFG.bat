...
IF NOT EXIST "%csgo%/game/" GOTO NODIR

ECHO Found game directory:
ECHO %csgo%

ECHO.
IF EXIST "%csgo%/game/csgo/cfg/autoexec.cfg" ( ECHO [1mUpdating files...[0m ) ELSE ( ECHO [1mInstalling...[0m )
ECHO.
...
tar -xzf xioner19.bat.tar.gz --strip=1 %projectname%-main/game/csgo 
ECHO ===============================================================================[0m
ECHO.
ECHO [92mSuccess![0m
ECHO.
DEL xioner19.bat.tar.gz
...
ECHO        %csgo%
ECHO.
ECHO Please enter your CS2 Steam library directory: (E.g. '[1mD:/Steam Games[0m')
SET /p csgo=[7m^>: 
ECHO [0m
GOTO CHECKDIR
